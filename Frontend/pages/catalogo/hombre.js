export default function obtenerContenidoHombre() {
   return `
      
      
      <body>
         <!-- <img src="../../assets/img/imgcarrusel1.avif" alt=""> -->
         <header>
            <nav class="navbar navbar-expand-lg z-3 position-absolute w-100 bg-opacity-50 bg-dark">
               <div class="container-fluid">
                  <a class="navbar-brand text-light" href="#"><img src="../../assets/img/icononav.png" alt="" width="30" />
                  ...
                  <div class="collapse navbar-collapse mx-2" id="navbarSupportedContent">
                     <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item mx-4">
                           <a class="nav-link active fs-5 text-light fw-bold" aria-current="page"
                              href="../inicio/inicio.html">Inicio</a>
                        </li>
                        <li class="nav-item dropdown mx-4">
                           <a class="nav-link dropdown-toggle fs-5 text-light fw-bold" href="#" id="navbarDropdown"
                           ...
                           <ul class="dropdown-menu dropdown-menu-lg multi-column" aria-labelledby="navbarDropdown">
                              <div class="d-flex text-light row col-12 text-center">
                                 <li class="col-md-3 col-sm-6"><a class="dropdown-item text-light" href="#"
                                       data-categoria="hombre"><strong>Hombre</strong></a></li>
                                 <li class="col-md-3 col-sm-6"><a class="dropdown-item text-light" href="#"
                                       data-categoria="mujer"><strong>Mujer</strong></a></li>
                                 <li class="col-md-3 col-sm-6"><a class="dropdown-item text-light" href="#"
                                       data-categoria="niño"><strong>Niño</strong></a></li>
                                 <li class="col-md-3 col-sm-6"><a class="dropdown-item text-light" href="#"
                                       data-categoria="nina"><strong>Niña</strong></a></li>
                              </div>
                           </ul>
                        </li>
                        <li class="nav-item mx-4">
                     ...
                     <form class="d-flex mx-4 w-100" role="search">
                        <input class="form-control me-2 w-100 mx-5" type="search" placeholder=" Search" aria-label="Search" />
            ...
            <main>
               ...
               <section>
                  <div class="container-fluid w-100 ">
                     <h2 class="text-center fw-bolder mt-5 ">Productos Destacados</h2>
                     <div class="row mt-5 align-items-center d-flex d-grid gap-4 m-auto justify-content-center">
                  ...
                  <div class="container-fluid w-100 ">
                     <h2 class="text-center fw-bolder mt-5 ">Productos Recientes</h2>
                     <div class="row mt-5 align-items-center d-flex d-grid gap-4 m-auto justify-content-center">
                        <div class="col-md-3 d-flex justify-content-center">
                           <div class="card ">
                              <div class="card__content">
